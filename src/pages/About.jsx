      ...
      <div className="my-10 flex flex-col md:flex-row gap-12">
        ...
        <div className="flex flex-col justify-center gap-6 md:w-2/4 text-sm text-gray-600 ">
          ...
          <p>
            ...
            advancements to improve user experience an deliver superior service.
          ...
          <p>
            Our vision at Prescripto to create a seamless healthcare experience
            for every user. we aim to bridge patients and healthcare provides,
            making it easier for you to access thr care you need, when you need
            it.
          </p>
        </div>
      </div>
